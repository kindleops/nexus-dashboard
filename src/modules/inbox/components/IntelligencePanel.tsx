...
const logIntelligencePanelData = (thread: WorkflowThread) => {
  if (!DEV) return
...
const PremiumPropertySnapshotCard = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
...
const TimelineCard = ({ thread }: { thread: WorkflowThread }) => {
  const stageVisual = getSellerStageVisual(thread.conversationStage)
  const autoVisual = automationStateVisuals[thread.automationState]
...
const buildMatchBadges = (thread: WorkflowThread, intelligence: ThreadIntelligenceRecord | null) => {
...
export const OverviewPanel = ({ thread, intelligence, messages }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null; messages: ThreadMessage[] }) => {
  const action = getNextBestAction(thread)
...
export const ProspectPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
...
export const OwnerPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => (
  <div className="nx-intel-panel-grid">
...
export const PropertyIntelPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
  const snapshot = normalizePropertySnapshot(intelligence, thread)
...
export const PortfolioPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => (
  <div className="nx-intel-panel-grid">
...
export const FinancialPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
...
export const ConversationPanel = ({ thread, intelligence, messages }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null; messages: ThreadMessage[] }) => {
...
export const AutomationPanel = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
  const autoVisual = automationStateVisuals[thread.automationState]
  return (
    <div className="nx-intel-panel-grid">
...
export const PropertySnapshotCard = ({ thread, intelligence }: { thread: WorkflowThread; intelligence: ThreadIntelligenceRecord | null }) => {
  const snapshot = normalizePropertySnapshot(intelligence, thread)
...
export const DealStateCard = ({ thread }: { thread: WorkflowThread }) => {
...
const LinkedAppsCard = ({ thread }: { thread: WorkflowThread }) => {
  const baseUrl = 'https://app.realestateflow.ai'
